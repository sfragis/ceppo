...
import eu.fabiostrozzi.dslog.DSLogConfig;
...
public class HBaseAdapter implements Adapter {
    ...
    public void log(DSLogLevel level, Date timestamp, ThreadContext context, Term... terms) {
        ...
        String node = DSLogConfig.getConfiguration().getNode();
    ...
    /*
     * (non-Javadoc)
     * @see eu.fabiostrozzi.dslog.adapter.Adapter#init(java.util.Properties)
     */
    @Override
