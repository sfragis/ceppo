...
public abstract class BaseGrammar {
     ...
     * @param level
     */
    public BaseGrammar(CeppoLevel level) {
        this.level = level;
    ...
    /*
     * (non-Javadoc)
     * @see eu.fabiostrozzi.ceppo.lang.ClosureStatement#log(eu.fabiostrozzi.ceppo.Ceppo)
     */
    public void log(Ceppo log) {
